    ...
    function addInputListeners() {
        ...
        fullName.addEventListener('input', () => {
            ...
            if (!value.trim()) {
                ...
                fullNameError.textContent = 'Name can only contain letters, spaces, dots, or hyphens.';
            } else if (/^\s/.test(value)) {
                fullNameError.textContent = 'Name cannot start with a space.';
            } else if (/\s{2,}/.test(value)) {
                fullNameError.textContent = 'Name cannot contain multiple spaces in a row.';
            } else {
        ...
        email.addEventListener('input', () => {
            if (!email.value.trim()) {
                ...
                emailError.textContent = 'Email Formation must be "YY-XXXXX-Z@student.aiub.edu"';
            } else {
